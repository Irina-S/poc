$(document).ready(function() {
    ...
    function init() {
        ...
        try {
            ...
            const centerMap = [52.04135773002747, 113.50185693383786];
            ...
            // Создание точек
            // Сюда прописывается селектор, в data-атрибутах которого искать координаты
            $('.contacts-list__item, select.pick-point option[data-addr-id]').each(function(index, item) {
